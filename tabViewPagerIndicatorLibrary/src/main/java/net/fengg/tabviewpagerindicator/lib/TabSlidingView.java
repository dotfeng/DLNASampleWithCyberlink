...
public class TabSlidingView extends HorizontalScrollView {
	...
	public TabSlidingView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public TabSlidingView(Context context, AttributeSet attrs, int defStyle) {
		...
		a = context.obtainStyledAttributes(attrs, R.styleable.TabSlidingView);

		indicatorColor = a.getColor(R.styleable.TabSlidingView_pstsIndicatorColor, indicatorColor);
		underlineColor = a.getColor(R.styleable.TabSlidingView_pstsUnderlineColor, underlineColor);
		dividerColor = a.getColor(R.styleable.TabSlidingView_pstsDividerColor, dividerColor);
		indicatorHeight = a.getDimensionPixelSize(R.styleable.TabSlidingView_pstsIndicatorHeight, indicatorHeight);
		underlineHeight = a.getDimensionPixelSize(R.styleable.TabSlidingView_pstsUnderlineHeight, underlineHeight);
		dividerPadding = a.getDimensionPixelSize(R.styleable.TabSlidingView_pstsDividerPadding, dividerPadding);
		tabPadding = a.getDimensionPixelSize(R.styleable.TabSlidingView_pstsTabPaddingLeftRight, tabPadding);
		tabBackgroundResId = a.getResourceId(R.styleable.TabSlidingView_pstsTabBackground, tabBackgroundResId);
		shouldExpand = a.getBoolean(R.styleable.TabSlidingView_pstsShouldExpand, shouldExpand);
		scrollOffset = a.getDimensionPixelSize(R.styleable.TabSlidingView_pstsScrollOffset, scrollOffset);
		textAllCaps = a.getBoolean(R.styleable.TabSlidingView_pstsTextAllCaps, textAllCaps);
...
//			}
	...
	public boolean isIndicatorBelow() {
		return indicatorBelow;
	}

	public void setIndicatorBelow(boolean indicatorBelow) {
		this.indicatorBelow = indicatorBelow;
	}
